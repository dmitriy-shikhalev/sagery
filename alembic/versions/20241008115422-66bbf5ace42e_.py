...
Revision ID: 66bbf5ace42e
Revises: 
Create Date: 2024-10-08 11:54:22.961389
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_vars_status'), 'vars', ['status'], unique=False)
    ...
    op.create_index(op.f('ix_objects_var_id'), 'objects', ['var_id'], unique=False)
    ...
    op.create_index(op.f('ix_requests_object_id'), 'requests', ['object_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_requests_object_id'), table_name='requests')
    op.drop_table('requests')
    op.drop_index(op.f('ix_items_object_id'), table_name='items')
    op.drop_index(op.f('ix_items_key'), table_name='items')
    op.drop_table('items')
    op.drop_index(op.f('ix_objects_var_id'), table_name='objects')
    op.drop_index(op.f('ix_objects_status'), table_name='objects')
    op.drop_index(op.f('ix_objects_index'), table_name='objects')
    op.drop_table('objects')
    op.drop_index('uix_job_var', table_name='vars')
    op.drop_index(op.f('ix_vars_status'), table_name='vars')
